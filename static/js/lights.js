...
const changeColour = async (c) => {
    let light = document.getElementById('light').value || "Rick";
    let hue = hexToRGBThenXY(c || document.getElementById('hue').value);

    let response = await fetch(`/api/hue/${light}/${hue}/`, {
        method: "POST"
...
document.getElementById("magenta").addEventListener("click", () => changeColour("#FF00FF"), false);
document.getElementById("blue").addEventListener("click", () => changeColour("#007BFF"), false);
document.getElementById("green").addEventListener("click", () => changeColour("#00FF95"), false);
document.getElementById("red").addEventListener("click", () => changeColour("#FF002F"), false);
